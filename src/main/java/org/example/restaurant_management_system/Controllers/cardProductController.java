...
import org.example.restaurant_management_system.Controllers.mainFormController;
...
public class cardProductController implements Initializable {
    ...
    @FXML
    public Label prod_name;

    @FXML
    public Label prod_price;

    @FXML
    public ImageView prod_imageView;

    @FXML
    public Spinner<Integer> prod_spinner;

    @FXML
    public Button prod_addBtn;
